...
<html lang="en">
    ...
    <body>
        <div class="row" style="height: 18vh">     
            <div class="col-2">
                <img src="images\iitjammu.jpg" alt="logo" style="height: 7pc;width: 8pc;border-radius: 50%;margin: 3% 3% 0% 3%">
            </div>

            <div class="col-8">
                <h3 class="text-center" style="margin-top: 2%">Indian Institute Of Technology</h3>
                <p class="text-center">Jammu,Nagrota (Jammu Kashmir)</p>
                
            </div>

            <div class="col-2">                    
                <div class="social_media" style="margin-top:10%;margin-left:2%;font-size: 23pt">
                    <a href="facebook.com" class="icoFacebook" title="Facebook"><i class="fab fa-facebook"></i></a>
                    <a href="twitter.com" class="icoTwitter" title="Twitter"> <i class="fab fa-twitter"></i></a>                     
                    <a href="https://www.google.com" target="_blank" class="icoGoogle" title="Google +"><i class="fab fa-google-plus"></i></a>
                    <a href="linkedin.com" class="icoLinkedin" title="Linkedin"><i class="fab fa-linkedin"></i></a>
